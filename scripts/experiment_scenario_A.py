...
def main():
    ...
    if USE_EXPANDED_DATA:
        ...
        column_sections_df = pd.read_csv("../data/column_sections_expanded_rotated.csv")
        h5_file = h5py.File('../data/pm_dataset_expanded_rotated.mat', 'r')
    else:
        print("[Experiment] Using ORIGINAL column dataset.")
        beam_sections_df = pd.read_csv("../data/beam_sections_simple02.csv")
        column_sections_df = pd.read_csv("../data/column_sections_simple02.csv")
        h5_file = h5py.File('../data/pm_dataset_simple02.mat', 'r')
    ...
    output_folder = "../results/Results_Scenario_A_02"
