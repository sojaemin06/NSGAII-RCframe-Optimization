...
def plot_comparison_from_csv():
    ...
    for method in parent_selection_methods:
        ...
        method_folder = f"../results/parent_selection_{method}_02"
    ...
    save_path_conv = "../results/parent_selection_convergence.png"
    ...
    save_path_pareto = "../results/parent_selection_pareto.png"
